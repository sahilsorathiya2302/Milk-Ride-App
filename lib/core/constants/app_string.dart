class AppString {
  ...
  static const String registerMobileNumberPrompt =
      "Please enter your register details";
  static const String otpPrompt = "Enter the code sent to the number";
  static const String submit = "Submit";
  static const String notReceiveCode = "Didn't receive Code?";
  static const String next = "Next";
  static const String personal = "Personal Details";
  static const String address = "Address Details";
  ...
  static const String titleSocietyName = "Society Name";
  static const String titleLandMarks = "LandMark";
  static const String titleCity = "Region/City";
  static const String titleArea = "Select Area";
  static const String titlePinCode = "PIN Code";
  static const String titleReferralCode = "Referral Code (Optional)";
